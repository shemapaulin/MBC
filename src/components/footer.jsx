            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-start space-x-3">
                <a
                  ...
                  href="https://www.facebook.com/mubugabiocoffee"
                  title="Facebook"
                  className="flex items-center p-1"
                >
                  <Link to="https://www.facebook.com/mubugabiocoffee">
                  <svg
                ...
                <a
                  rel="noopener noreferrer"
                  href="https://twitter.com/mubugabiocoffee"
                  title="Twitter"
                  className="flex items-center p-1"
                >
                  <Link to="https://twitter.com/mubugabiocoffee">
                  <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 fill-current"
                ...
                <a
                  rel="noopener noreferrer"
                  href="https://www.instagram.com/mubugabiocoffee/"
                  title="Instagram"
                  className="flex items-center p-1"
                >
                  <Link to="https://www.instagram.com/mubugabiocoffee/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 32 32"
                    fill="currentColor"
