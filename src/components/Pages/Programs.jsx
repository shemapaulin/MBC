    ...
    <>
      ...
      <div className="bg-gradient-to-r from-white/10 to-transparent pb-10">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-9 space-y-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-snug mt-4">Programs</h1>
          <p className="text-xl sm:text-2xl text-gray-100 font-semibold">Explore our key programs aimed at improving the community and commemorating important events.</p>
        </div>
      </div>

      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h3 className="text-3xl font-bold md:text-4xl md:leading-tight text-white mb-10">Programs Ahead</h3>
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-16 mx-auto bg-white">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="max-w-md">
              <h2 className="text-2xl font-bold md:text-3xl md:leading-tight text-black">Subscribe</h2>
            ...
            <form>
              <div className="w-full sm:max-w-lg md:ms-auto">
                <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto whitespace-nowrap py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-black text-white hover:bg-lime-700 disabled:opacity-50 disabled:pointer-events-none"
                  >
                    Subscribe
                  </button>
                </div>
