...
const contact = () => {
  return (
    ...
    <br/>
    <br/>
    <div className="grid max-w-screen-xl pt-20 grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32  bg-white text-lime-600 ">
	...
	<form noValidate="" className="space-y-6">
		<div>
			...
			<input id="name" type="text" placeholder="" className="w-full p-3 rounded border border-black bg-gray text-black" />
		</div>
		<div>
			<label htmlFor="email" className="text-sm">Email</label>
			<input id="email" type="email" className="w-full p-3 rounded border border-black bg-gray text-black" />
		</div>
		<div>
